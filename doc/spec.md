...
* Randomly find two records that are not generated by its own from the tailing records of the DAG.
...
* Once there are two valid tailing records and their ancestors are also valid, append your new record to these two records by putting the names of these two records into your record's header.
